// 人気サブスクリプションサービスの料金データ (2025年9月現在)
export const POPULAR_SERVICES = {
  ...
  "Amazon Prime 月額": {
    ...
    cycle: "MONTHLY",
    category: "動画配信・配送",
    url: "https://www.amazon.co.jp/gp/primecentral?ref_=ya_d_c_prime",
  },
  "Amazon Prime 年額": {
    price: 5900,
    cycle: "YEARLY",
  ...
  "Amazon Prime Student 月額": {
    price: 300,
    cycle: "MONTHLY",
    category: "動画配信・配送",
    url: "https://www.amazon.co.jp/gp/primecentral?ref_=ya_d_c_prime",
  },
  "Amazon Prime Student 年額": {
    price: 2950,
    cycle: "YEARLY",
    category: "動画配信・配送",
    url: "https://www.amazon.co.jp/gp/primecentral?ref_=ya_d_c_prime",
  ...
  "Amazon Music Unlimited 個人": {
    price: 1080,
    cycle: "MONTHLY",
    category: "音楽配信",
    url: "https://music.amazon.co.jp/",
  },
  "Amazon Music Unlimited ファミリー": {
    price: 1680,
    cycle: "MONTHLY",
    category: "音楽配信",
    url: "https://music.amazon.co.jp/",
  ...
  "Evernote Personal": {
    ...
    cycle: "MONTHLY",
    category: "生産性ツール",
    url: "https://evernote.com/intl/jp/pricing",
  },
  "Evernote Personal 年額": {
    price: 9000,
    cycle: "YEARLY",
    category: "生産性ツール",
    url: "https://evernote.com/intl/jp/pricing",
